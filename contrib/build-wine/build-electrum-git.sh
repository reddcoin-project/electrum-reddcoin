...
pushd $WINEPREFIX/drive_c/electrum-redd
...
for i in ./locale/*; do
    dir=$WINEPREFIX/drive_c/electrum-redd/electrum_redd/$i/LC_MESSAGES
    mkdir -p $dir
...
cd dist
mv electrum-redd-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
