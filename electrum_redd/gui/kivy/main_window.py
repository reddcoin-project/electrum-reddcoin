...
from electrum_redd.wallet_db import WalletDB
from electrum_redd.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet
from electrum_redd.plugin import run_hook
from electrum_redd import util
from electrum_redd.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                                format_satoshis, format_satoshis_plain, format_fee_satoshis,
                                maybe_extract_bolt11_invoice)
from electrum_redd.invoices import PR_PAID, PR_FAILED
from electrum_redd import blockchain
from electrum_redd.network import Network, TxBroadcastError, BestEffortRequestFailed
...
#Factory.register('InstallWizard', module='electrum_redd.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_redd.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_redd.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_redd.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_redd_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_redd.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrum_redd/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_redd/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_redd/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_redd/gui/kivy/data/fonts/Roboto-Bold.ttf')


from electrum_redd.util import (NoDynamicFeeEstimates, NotEnoughFunds)
...
if TYPE_CHECKING:
    ...
    from electrum_redd.plugin import Plugins
...
class ElectrumWindow(App):
    ...
    def _process_invoice_str(self, invoice: str) -> None:
        ...
        if not self.send_screen:
            ...
            self._invoice_intent_queued = invoice
            return
        if invoice.lower().startswith('reddcoin:'):
    ...
    def on_qr(self, data):
        from electrum_redd.bitcoin import is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_redd/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_redd.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_redd.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_redd_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_redd_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "electrum_redd/gui/icons/electrum.png"
    ...
    def get_max_amount(self):
        from electrum_redd.transaction import PartialTxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-Redd', message,
                            app_icon=icon, app_name='Electrum-Redd')
        except ImportError:
