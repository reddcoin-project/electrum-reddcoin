...
from electrum_redd import WalletStorage, Wallet
...
from electrum_redd.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def network_dialog(self):
        print("use 'electrum-redd setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-redd setconfig' to change your settings")
        return True
