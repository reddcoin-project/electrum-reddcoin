...
from electrum_redd.util import base_units_list
from electrum_redd.i18n import languages
from electrum_redd.gui.kivy.i18n import _
from electrum_redd.plugin import run_hook
from electrum_redd import coinchooser
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_redd/gui/kivy/uix/ui_screens/proxy.kv')
