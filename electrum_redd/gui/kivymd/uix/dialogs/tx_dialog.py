...
from electrum_redd.util import InvalidPassword
from electrum_redd.address_synchronizer import TX_HEIGHT_LOCAL
from electrum_redd.wallet import CannotBumpFee
...
class TxDialog(Factory.Popup):
    ...
    def show_qr(self):
        from electrum_redd.bitcoin import base_encode, bfh
