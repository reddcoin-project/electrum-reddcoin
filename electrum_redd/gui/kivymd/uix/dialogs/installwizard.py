...
#:import _ electrum_redd.gui.kivy.i18n._
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            Label:
                ...
                font_size: '33sp'
                font_name: 'electrum_redd/gui/kivy/data/fonts/tron/Tr2n.ttf'
        GridLayout:
            cols: 1
            id: crcontent
            spacing: '1dp'
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_redd.mnemonic import Mnemonic
        from electrum_redd.old_mnemonic import wordlist as old_wordlist
