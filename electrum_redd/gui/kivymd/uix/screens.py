...
from electrum_redd.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_redd.invoices import (PR_TYPE_ONCHAIN, PR_TYPE_LN, PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                                    PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                                    LNInvoice, pr_expiration_values, Invoice, OnchainInvoice)
from electrum_redd import bitcoin, constants
from electrum_redd.transaction import Transaction, tx_from_any, PartialTransaction, PartialTxOutput
from electrum_redd.util import parse_URI, InvalidBitcoinURI, TxMinedInfo, maybe_extract_bolt11_invoice
from electrum_redd.plugin import run_hook
from electrum_redd.wallet import InternalAddressCorruption
from electrum_redd import simple_config
from electrum_redd.simple_config import FEERATE_WARNING_HIGH_FEE, FEE_RATIO_HIGH_WARNING
from electrum_redd.lnaddr import lndecode
from electrum_redd.lnutil import RECEIVED, SENT, PaymentFailure
...
if TYPE_CHECKING:
    from electrum_redd.gui.kivy.main_window import ElectrumWindow
...
Builder.load_file('electrum_redd/gui/kivy/uix/ui_screens/history.kv')
Builder.load_file('electrum_redd/gui/kivy/uix/ui_screens/send.kv')
Builder.load_file('electrum_redd/gui/kivy/uix/ui_screens/receive.kv')
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_redd.util import create_bip21_uri
        amount = self.amount
        if amount:
