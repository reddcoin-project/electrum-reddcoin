...
from electrum_redd.util import print_msg, create_and_start_event_loop
from electrum_redd.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <reddcoin_address>")
    sys.exit(1)
