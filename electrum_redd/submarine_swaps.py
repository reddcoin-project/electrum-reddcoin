...
API_URL_MAINNET = 'https://swaps.electrum-redd.org/api'
API_URL_TESTNET = 'https://swaps.electrum-redd.org/testnet'
...
class SwapManager(Logger):
    ...
    async def normal_swap(self, lightning_amount: int, expected_onchain_amount: int,
        ...
        """send on-chain RDD, receive on Lightning"""
    ...
    async def get_pairs(self) -> None:
        ...
        limits = pairs['pairs']['RDD/RDD']['limits']
