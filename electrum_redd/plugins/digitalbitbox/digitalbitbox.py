...
from electrum_redd.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_redd.bitcoin import public_key_to_p2pkh
from electrum_redd.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_redd import ecc
from electrum_redd.ecc import msg_magic
from electrum_redd.wallet import Standard_Wallet
from electrum_redd import constants
from electrum_redd.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_redd.i18n import _
from electrum_redd.keystore import Hardware_KeyStore
from electrum_redd.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_redd.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_redd.network import Network
from electrum_redd.logging import get_logger
from electrum_redd.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-Redd-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
...
class DigitalBitboxPlugin(HW_PluginBase):
    ...
    def setup_device(self, device_info, wizard, purpose):
        ...
        wizard.run_task_without_blocking_gui(
            task=lambda: client.get_xpub("m/44'/4'", 'standard'))
        return client
