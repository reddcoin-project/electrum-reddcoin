...
from electrum_redd.gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
                                       OkButton, CloseButton)
from electrum_redd.i18n import _
from electrum_redd.plugin import hook
from electrum_redd.util import bh2u
    ...
    def request_safe_t_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_redd.bip32 import is_xprv
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        clear_pin_warning = QLabel(
            _("If you disable your PIN, anyone with physical access to your "
              "{} device can spend your reddcoins.").format(plugin.device))
