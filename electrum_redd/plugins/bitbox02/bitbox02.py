...
from electrum_redd import bip32, constants
from electrum_redd.i18n import _
from electrum_redd.keystore import Hardware_KeyStore
from electrum_redd.transaction import PartialTransaction
from electrum_redd.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from electrum_redd.util import bh2u, UserFacingException
from electrum_redd.base_wizard import ScriptTypeNotSupported, BaseWizard
from electrum_redd.logging import get_logger
from electrum_redd.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_redd.simple_config import SimpleConfig
from electrum_redd.json_db import StoredDict
from electrum_redd.storage import get_derivation_used_for_hw_device_encryption
from electrum_redd.bitcoin import OnchainOutputType

import electrum_redd.bitcoin as bitcoin
import electrum_redd.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def coin_network_from_electrum_network(self) -> int:
        if constants.net.TESTNET:
            return bitbox02.btc.TRDD
        return bitbox02.btc.RDD
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            if coin_network == bitbox02.btc.RDD:
    ...
    def _get_coin(self):
        return bitbox02.btc.TRDD if constants.net.TESTNET else bitbox02.btc.RDD
