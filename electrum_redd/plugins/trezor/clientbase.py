...
from electrum_redd.util import UserCancelled, UserFacingException
from electrum_redd.keystore import bip39_normalize_passphrase
...
from electrum_redd.plugins.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def get_passphrase(self, available_on_device):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the reddcoins in the wallet.").format(self.device)
        else:
