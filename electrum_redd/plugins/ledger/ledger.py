...
from electrum_redd.crypto import hash_160
from electrum_redd.bitcoin import int_to_hex, var_int, is_segwit_script_type
from electrum_redd.bip32 import BIP32Node, convert_bip32_intpath_to_strpath
from electrum_redd.i18n import _
from electrum_redd.keystore import Hardware_KeyStore
from electrum_redd.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_redd.wallet import Standard_Wallet
from electrum_redd.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_redd.base_wizard import ScriptTypeNotSupported
from electrum_redd.logging import get_logger
from electrum_redd.plugin import runs_in_hwd_thread
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Reddcoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Reddcoin mode")) from e
                raise e
...
class LedgerPlugin(HW_PluginBase):
    ...
    def setup_device(self, device_info, wizard, purpose):
        ...
        wizard.run_task_without_blocking_gui(
            task=lambda: client.get_xpub("m/44'/4'", 'standard'))  # TODO replace by direct derivation once Nano S > 1.1
        return client
