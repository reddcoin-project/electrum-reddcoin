...
FEERATE_STATIC_VALUES = [1000000, 2000000, 3000000, 5000000, 7000000, 10000000,
...
class SimpleConfig(Logger):
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'rdd':8, 'mrdd':5, 'urdd':2, 'bits':2, 'sat':0}
    ...
    def get_wallet_path(self, *, use_gui_last_wallet=False):
        ...
        old_path = os.path.join(self.path, "electrum-redd.dat")
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-redd.conf into user_config[]."""
    if not path:
        return {}
